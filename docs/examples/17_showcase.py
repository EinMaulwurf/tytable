...
(
    ...
    .style(i="groupj", bold=True, color="#153243", background="#dbeff0", align="c")
    .style(i="header", bold=True, color="white", background="#153243", align="c")
    .style(j="Model", bold=True, align="l")
    .style(j=["Accuracy", "F1", "Latency", "Parameters"], align="r")
